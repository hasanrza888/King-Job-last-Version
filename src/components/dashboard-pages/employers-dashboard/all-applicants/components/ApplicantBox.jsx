        ...
        <div className="content">
          ...
          <ul className="candidate-info">
            ...
            <li className="status_li">
              <span
                style={{
                  color: candidate?.status[candidate?.status.length - 1]?.color,
                }}
                className={
                  "icon " +
                  candidate?.status[candidate?.status.length - 1]?.icon
                }
              ></span>
              <span
                style={{
                  color: candidate?.status[candidate?.status.length - 1]?.color,
                  backgroundColor: "#C9F7F8",
                  padding: "8px",
                  borderRadius: "6px",
                }}
                onMouseEnter={() => setHoveredStatus(candidate)}
            ...
            <li>
              <button
                onClick={() =>
                  sendNewStatus(
                    candidate?._id,
                    "65a6ec29788f1a9ccd9f0e49",
                    true
                  )
                }
                data-text="Birbaşa qəbul et"
              >
            ...
            <li>
              <button
                onClick={() =>
                  sendNewStatus(
                    candidate?._id,
                    "65a6ea2a788f1a9ccd9f0e26",
                    true
                  )
                }
                data-text="Birbaşa ləğv et"
              >
