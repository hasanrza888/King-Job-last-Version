...
const Index = () => {
  ...
  return (
    <div className="page-wrapper dashboard">
      <SEO
        title = {`${user?.name} - Tapşırıqlar | KING JOB`}
        description = "Hesabınızdakı tapşırıqlar səhifəsində müraciətçilərə göndərmək üçün tapşırıq yarada və nəzərdən keçirə bilərsiniz !"
        name = "King Job" 
        ogType = "article"
