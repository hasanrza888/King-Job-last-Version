...
const Index = () => {
  ...
  return (
    <div className="page-wrapper dashboard">
      <SEO
        title = {`${user?.name} - Abunəliklərim | KING JOB`}
        description = "Hesabınızdakı Abunəliklərim səhifəsində abunə olduğunuz paketləri nəzərdən keçirə bilərsiniz !"
        name = "King Job" 
        ogType = "article"
