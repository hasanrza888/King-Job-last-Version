...
'use client'
import { fetchjobsandsearch } from "@/services/api/common_api";
        ...
        <div className="inner-box">
          <div className="content">
            <span className="company-logo">
              <Image width={50} height={49} loader={() => item.logo} src={item.logo} alt="item brand" />
            </span>
            <h4>
              <Link href={`/job-single-v1/${item._id}`}>{item.name}</Link>
            </h4>
            ...
            <ul className="job-info">
              ...
              {/* location info */}
              <li>
                <span className="icon flaticon-clock-3"></span> {item.createdAt.split('T')[0]}
              </li>
              {/* time info */}
              <li>
